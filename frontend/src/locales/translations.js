export const translations = {
  en: {
    title: "VerdAI",
    subtitlePart1: "AI-Powered Crop",
    subtitlePart2: "Health Intelligence",
    ...
    cardDetections: "Detections",
    cardAvgConfidence: "Avg Confidence",
    cardLastAnalysis: "Last Analysis",
    capDetectTitle: "Disease Detection",
    capDetectDesc: "Upload leaf photographs to execute computer vision diagnostic scanning.",
    capChatTitle: "AI Recommendations",
    capChatDesc: "Ask the context-aware chatbot for organic treatments, prevention guidelines, and spray advice.",
    capWeatherTitle: "Weather Intelligence",
    capWeatherDesc: "Assess temperature thresholds, rainfall indicators, and fungal risk alarms.",
    capAnalysisTitle: "Real-Time Analysis",
    capAnalysisDesc: "Inspect close-up leaf pathology symptoms side-by-side with bounding diagnostic targets.",
    capReportTitle: "PDF Reporting",
    capReportDesc: "Export structured summaries including severity, weather risk, and agro-advisories.",
    capHistoryTitle: "Prediction History",
    capHistoryDesc: "Review previous pathology diagnoses and treatment advice to track disease occurrences.",
    ...
    testSub: "See how VerdAI is helping protect yields and optimize farming.",
    ...
    // Footer
    footDesc: "VerdAI is an enterprise-grade AI Agriculture platform empowering farmers with instant pathology diagnostics and real-time weather intelligence.",
    footRights: "All Rights Reserved."
  },
  te: {
    title: "VerdAI",
    subtitlePart1: "AI-ఆధారిత పంట",
    subtitlePart2: "ఆరోగ్య విజ్ఞానం",
    ...
    cardDetections: "గుర్తింపులు",
    cardAvgConfidence: "సగటు ఖచ్చితత్వం",
    cardLastAnalysis: "చివరి విశ్లేషణ",
    capDetectTitle: "రోగ నిర్ధారణ",
    capDetectDesc: "కంప్యూటర్ విజన్ ద్వారా మొక్క ఆకు వ్యాధులను గుర్తించడానికి ఫోటోలను అప్‌లోడ్ చేయండి.",
    capChatTitle: "AI సిఫార్సులు",
    capChatDesc: "సేంద్రీయ చికిత్సలు, నివారణ మార్గదర్శకాలు మరియు పంట సలహాల కోసం చాట్‌బాట్‌ను అడగండి.",
    capWeatherTitle: "వాతావరణ సమాచారం",
    capWeatherDesc: "ఉష్ణోగ్రత పరిమితులు, వర్షపాతం సూచికలు మరియు తెగులు వ్యాప్తి అంచనాలను గమనించండి.",
    capAnalysisTitle: "నిజ సమయ విశ్లేషణ",
    capAnalysisDesc: "నిర్ధారణ లక్షణాలను మరియు రోగ నిర్ధారణ గురుతులను పక్కపక్కనే తనిఖీ చేయండి.",
    capReportTitle: "PDF నివేదికలు",
    capReportDesc: "వ్యాధి తీవ్రత, వాతావరణం మరియు సలహాలతో కూడిన నివేదికలను PDF రూపంలో డౌన్‌లోడ్ చేయండి.",
    capHistoryTitle: "చరిత్ర రికార్డులు",
    capHistoryDesc: "మునుపటి రోగ నిర్ధారణ నివేదికలను మరియు చికిత్స సలహాలను సమీక్షించండి.",
    ...
    testSub: "VerdAI పంట దిగుబడిని మరియు వ్యవసాయాన్ని ఎలా రక్షిస్తుందో చూడండి.",
    ...
    footDesc: "VerdAI అనేది పంట వ్యాధులను తక్షణమే గుర్తించడానికి మరియు వాతావరణ సలహాలను అందించడానికి ఉపయోగపడే ఒక ఆధునిక AI సాఫ్ట్‌వేర్.",
    footRights: "అన్ని హక్కులు ప్రత్యేకించబడ్డాయి."
  },
  hi: {
    title: "VerdAI",
    subtitlePart1: "AI-संचालित फसल",
    subtitlePart2: "स्वास्थ्य आसूचना",
    ...
    cardDetections: "सफलतापूर्वक पहचान",
    cardAvgConfidence: "औसत आत्मविश्वास",
    cardLastAnalysis: "अंतिम विश्लेषण",
    capDetectTitle: "रोग निदान",
    capDetectDesc: "कंप्यूटर विज़न द्वारा पत्ती के रोगों की पहचान करने के लिए चित्र अपलोड करें।",
    capChatTitle: "AI सिफारिशें",
    capChatDesc: "जैविक उपचार, रोकथाम दिशानिर्देशों और छिड़काव सलाह के लिए कृषि चैटबॉट से पूछें।",
    capWeatherTitle: "मौसम की जानकारी",
    capWeatherDesc: "तापमान सीमा, वर्षा संकेतकों और कवक (फंगल) के जोखिम स्तरों का आकलन करें।",
    capAnalysisTitle: "वास्तविक समय विश्लेषण",
    capAnalysisDesc: "पत्ती के रोग के लक्षणों और निदान लक्ष्यों का साथ-साथ निरीक्षण करें।",
    capReportTitle: "PDF रिपोर्टिंग",
    capReportDesc: "तीव्रता, मौसम के जोखिम और कृषि-सलाह सहित व्यवस्थित रिपोर्ट PDF में निर्यात करें।",
    capHistoryTitle: "पूर्वानुमान इतिहास",
    capHistoryDesc: "पिछली निदान रिपोर्टों और उपचार सलाहों की समीक्षा करके रोगों को ट्रैक करें।",
    ...
    testSub: "देखें कि VerdAI किस प्रकार फसलों को बचाने और कृषि को उन्नत बनाने में मदद कर रहा है।",
    ...
    footDesc: "VerdAI एक उच्च स्तरीय कृषि AI प्लेटफ़ॉर्म है जो किसानों को तत्काल रोग निदान और मौसम सलाह प्रदान करता है।",
